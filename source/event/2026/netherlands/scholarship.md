...
In order to foster a conference environment that better reflects the diversity of the community, the IIIF Consortium is pleased to announce two travel scholarships to attend the [Annual Conference][conference] being held this year in the Netherlands.
{{ theme.block-end }}
{{ theme.block-start }}
...
<div class="columns is-centered">{% include misc/button.html button_label="Learn more" button_link="/event/2026/netherlands/sponsorship" %}</div>
...
In an email to [admin@iiif.io](mailto:admin@iiif.io?subject=2026%20Travel%20Scholarship%20Application) with a subject line "2026 Travel Scholarship application," please provide the following: 
...
* A budget estimate for your stay in the Netherlands, using the [provided template](https://docs.google.com/spreadsheets/d/1MI7qnpbBqPHyg6Xww7XhRDX1iqyRoFJa1RoJbnTtukM/edit?usp=sharing). Please budget for a stay in Leiden that allows attendance at the Showcase, Conference, and Workshops (June 1-4).
...
[conference]: {{ site.root_url | absolute_url }}/event/2026/netherlands/
[sponsorship]: {{ site.root_url | absolute_url }}/event/2026/netherlands/sponsorship
